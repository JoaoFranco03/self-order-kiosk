        ...
        <Grid container>
          {orderItems.map((orderItem) => (
            <Grid item md={12} key={orderItem.name}>
              <Card
                className={[styles.card, styles.lessRounded, styles.gray]}
                ...
                <CardActionArea>
                  <CardContent>
                    <Box className={[styles.row, styles.between]}>
                      ...
                      <Button className={styles.rounded} variant="contained">Edit</Button>
                    </Box>
                    ...
                    <Box className={[styles.row, styles.between]}>
                      <Typography
                        ...
                        component="p"
                      >
                        {orderItem.quantity * orderItem.calorie} Cal
                      </Typography>
                      <Typography
                        variant="body2"
                        color="textPrimary"
