...
export const updateProduct = async (product, action) => {
    try {
        ...
        for (let i = 0; i < product.length; i++) {
            const productObject = {productID:productID[i], productQuantity:productQuantity[i]};
            await Axios.put("/api/products/" + productObject.productID, {
